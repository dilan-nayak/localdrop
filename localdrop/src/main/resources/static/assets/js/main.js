// 📄 main.js
// 🔗 Frontend logic for LocalDrop: handles file upload, download list, clipboard sync, WebSocket setup
document.addEventListener("DOMContentLoaded", () => {
    ...
    /**
     * 🌐 Connect to WebSocket server for real-time clipboard sharing
     */
    function connectWebSocket() {
        ...
        socket.onmessage = (event) => {
            ...
            // 💬 Show incoming clipboard message in chat log
    ...
    /**
     * 📤 Uploads a file to the server using Fetch + FormData
     * The peer's RSA public key is included to encrypt the AES file key
     */
    ...
    /**
     * 📃 Loads list of encrypted files from server and updates the UI
     */
    function loadFiles() {
    ...
    /**
     * 🔐 Loads and displays this device's RSA public key
     */
    ...
    /**
     * 🖱️ Drag-and-drop and click-based file upload
     */
